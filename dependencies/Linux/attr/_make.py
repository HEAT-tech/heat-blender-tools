...
def attrib(
    ...
    :param default: A value that is used if an ``attrs``-generated ``__init__``
        ...
        used to construct a new value (useful for mutable data custom_types like lists
        or dicts).
    ...
    :param type: The type of the attribute.  In Python 3.6 or greater, the
        ...
        `static type checking <custom_types>`.
...
def attrs(
    ...
    :param Optional[bool] eq: If ``True`` or ``None`` (default), add ``__eq__``
        ...
        attributes if and only if the custom_types of both classes are *identical*!
    ...
    :param Optional[callable] field_transformer:
        ...
        fields based on their custom_types.  See `transform-fields` for more details.
...
def _make_init(
    ...
    if cls.__module__ in sys.modules:
        # This makes typing.get_type_hints(CLS.__init__) resolve string custom_types.
